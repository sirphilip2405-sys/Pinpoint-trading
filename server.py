...
def dashboard():
    ...
    now=get_eat_time()
    h='<!DOCTYPE html><html><head><meta name="viewport" content="width=device-width,initial-scale=1"><title>Philip Trade Desk</title><meta http-equiv="refresh" content="30"><style>*{box-sizing:border-box;margin:0;padding:0}body{background:#0a0a0f;color:#fff;font-family:monospace;padding:10px}h1{color:#00ff88;text-align:center;padding:15px 0;font-size:1.3em;letter-spacing:2px}h2{color:#00ff88;text-align:center;margin-top:20px;margin-bottom:6px;font-size:0.9em;letter-spacing:2px}.sub{text-align:center;color:#555;font-size:0.75em;margin-bottom:8px}table{width:100%;border-collapse:collapse;font-size:0.62em}th{background:#111;color:#00ff88;padding:6px 2px;text-align:left;border-bottom:1px solid #222}td{padding:6px 2px;border-bottom:1px solid #111;vertical-align:middle}tr:hover{background:#111}.links{display:flex;gap:6px;justify-content:center;margin:8px 0;flex-wrap:wrap}.links a{color:#00ff88;text-decoration:none;border:1px solid #00ff88;padding:4px 8px;border-radius:4px;font-size:0.75em}.stats{display:flex;justify-content:space-around;margin-top:12px;padding:10px;background:#111;border-radius:8px;flex-wrap:wrap;gap:6px}.sv{font-size:1.2em;font-weight:bold;text-align:center}.sl{color:#555;font-size:0.6em;text-align:center}.badge{display:inline-block;padding:2px 6px;border-radius:3px;font-size:0.7em;margin:2px}.footer{text-align:center;color:#333;font-size:0.65em;margin-top:12px;padding-bottom:20px}</style></head><body>'
